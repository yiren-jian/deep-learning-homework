...
def mean_squared_error_test():
    """
    Provides Unit tests for the MeanSquaredError autograd Function.
    ...
    X2 (Tensor): size (48 x 2) denoting another set of inputs
    ...
    l = mean_squared_error(X1,X2)
    l.backward()

    is_correct = torch.autograd.gradcheck(mean_squared_error, inputs=(X1,X2), eps=DELTA, atol=TOL)
    print(is_correct)
    err = {}
